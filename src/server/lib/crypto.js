...
var Crypto = (function () {
  ...
  var sha256 = (byteArray) =>
    Utilities.computeDigest(Utilities.DigestAlgorithm.SHA_256, byteArray);
  ...
  var randomSaltHex = () => randomBytesHex(SALT_BYTES);

  // Iterated SHA-256 over (salt || password), feeding the previous digest back.
  var derive = (password, saltHex, iterations) => {
  ...
  var randomToken = () => randomBytesHex(32);
